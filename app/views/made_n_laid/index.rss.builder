xml.rss( :version => '2.0', 'xmlns:atom' => 'http://www.w3.org/2005/Atom' ) do
  xml.channel do
    ...
    xml.tag!( 'atom:link', { :href => made_n_laid_list_url( :format => 'rss' ), :rel => 'self', :type => 'application/rss+xml' } )
    xml << render(:partial => 'made_n_laid/instrument', :collection => @instruments ) unless @instruments.empty?
  end
end